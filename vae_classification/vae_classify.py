...
from vae_classification.vae_utils import init_weights,training_M2,test_M2,training_VAE
import torch
...
if __name__ == '__main__':
    ...
    print(m2)
    writer = SummaryWriter('class_log_antenna2')

    while epoch<EPOCH:
        epoch+=1
        print("\nepoch: ",epoch)
        training_M2(m2,vae,labelled,optimizer,cuda,training_data,training_data_labelled,training_data_unlabelled,writer,epoch)
